package com.djsoftware.quadra.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.djsoftware.quadra.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.djsoftware.quadra.repository.UserRepository.USERS_BY_EMAIL_CACHE);
